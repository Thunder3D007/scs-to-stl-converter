...
export const metadata: Metadata = {
  ...
  description: "Convert HOOPS Stream Cache (.scs) files to STL format with 3D preview. Fast, private, browser-based conversion using the official HOOPS Communicator engine.",
